...
class StepTwo_P2 : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this)
            .asGif()
            .load(R.drawable.cfan_p2)
            .into(findViewById(R.id.gifImageView))
    }
    fun onScreenTapped(view: View) {
        val intent = Intent(this, StepTwo_P3::class.java)
    ...
    private fun setupButtonListeners() {
        bckButton.setOnClickListener {
            startActivity(Intent(this, StepTwo_P1::class.java))
            overridePendingTransition(R.animator.fade_in, R.animator.fade_out)
        }
    }
