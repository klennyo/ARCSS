...
class StepFive_GPU_P4 : AppCompatActivity(), Detector.DetectorListener {
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        runOnUiThread {
            ...
            val lanCardBoxes = boundingBoxes.filter { it.clsName == " Graphics card socket" }
            ...
            if (bestBox != null) {
                ...
                statusTextView.text = "PLUG THE GPU IN THE BOX!"
                statusTextView.visibility = View.VISIBLE
                nextButton.visibility = View.VISIBLE
                ...
                statusTextView.text = "NO GPU SOCKET DETECTED"
                statusTextView.visibility = View.VISIBLE
    ...
    private fun goToNextInterface() {
        val intent = Intent(this, StepSix_LANCARD_P1::class.java)
