...
import com.surendramaran.yolov8tflite.Constants.TESTLABELS_PATH
import com.surendramaran.yolov8tflite.Constants.TEST_PATH
import com.surendramaran.yolov8tflite.databinding.ActivityMainBinding
import java.util.concurrent.ExecutorService
import java.util.concurrent.Executors

class MBTesting : AppCompatActivity(), Detector.DetectorListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detector = Detector(baseContext, TEST_PATH, TESTLABELS_PATH, this)
        detector.setup()
    ...
    private fun setupButtonListeners() {
        bckButton.setOnClickListener {
            startActivity(Intent(this, StepOne_P1::class.java))
    ...
    private fun goToNextInterface() {
        val intent = Intent(this, StepTwo_P1::class.java)
