...
class StepTwo_P3 : AppCompatActivity(), Detector.DetectorListener {
    ...
    private fun setupButtonListeners() {
        bckButton.setOnClickListener {
            startActivity(Intent(this, StepTwo_P2::class.java))
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        runOnUiThread {
            ...
            val lanCardBoxes = boundingBoxes.filter { it.clsName == " CPU fan interface" }
            ...
            if (bestBox != null) {
                ...
                statusTextView.text = "PLUG THE CABLE HERE!"
                statusTextView.visibility = View.VISIBLE
                nextButton.visibility = View.VISIBLE
                ...
                statusTextView.text = "NO CPU FAN INTERFACE DETECTED"
                statusTextView.visibility = View.VISIBLE
    ...
    private fun goToNextInterface() {
        val intent = Intent(this, StepThree_P1::class.java)
