...
class StepThree_P2 : AppCompatActivity(), Detector.DetectorListener {
    ...
    private fun setupButtonListeners() {
        bckButton.setOnClickListener {
            startActivity(Intent(this, StepThree_P1::class.java))
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        runOnUiThread {
            ...
            val lanCardBoxes = boundingBoxes.filter { it.clsName == " Memory socket" }
            ...
            if (bestBox != null) {
                ...
                statusTextView.text = "PLACE THE RAM IN THE MEMORY SLOT!"
                statusTextView.visibility = View.VISIBLE
                nextButton.visibility = View.VISIBLE
                ...
                statusTextView.text = "NO MEMORY SOCKET DETECTED"
                statusTextView.visibility = View.VISIBLE
    ...
    private fun goToNextInterface() {
        val intent = Intent(this, ChooseStorage::class.java)
