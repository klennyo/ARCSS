...
class StepSeven_POWER_P3 : AppCompatActivity(), Detector.DetectorListener {
    ...
    private fun setupButtonListeners() {
        bckButton.setOnClickListener {
            startActivity(Intent(this, StepSeven_POWER_P3::class.java))
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        ...
        runOnUiThread {
            ...
            val usb20Boxes = boundingBoxes.filter { it.clsName == " CPU power interface" }
            val usb30Boxes = boundingBoxes.filter { it.clsName == " Power Interface" }
            ...
            if (boxesToDisplay.isNotEmpty()) {
                statusTextView.text = "PLUG HERE, TO THE POWER INTERFACE"
            } else {
    ...
    private fun goToNextInterface() {
        val intent = Intent(this, StepEight_OC_P1::class.java)
