...
class Hands : AppCompatActivity(), Detector.DetectorListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detector = Detector(baseContext, HANDMODEL_PATH, HANDLABELS_PATH, this)
        detector.setup()
    ...
    override fun onEmptyDetect() {
        runOnUiThread {
            statusTextView.text = "Detecting hand. This may take some time!"
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        runOnUiThread {
            ...
            val handWithASWB = boundingBoxes.filter { it.clsName == "hand_with_aswb" }
            val handWithoutASWB = boundingBoxes.filter { it.clsName == "hand_without_aswb" }
            ...
            when {
                bestHandWithASWB != null -> {
                    ...
                    statusTextView.text = "GOOD TO GO!"
                ...
                bestHandWithoutASWB != null -> {
                    ...
                    statusTextView.text = "CAUTION: NO ASWB DETECTED"
                    statusTextView.setTextColor(ContextCompat.getColor(this, R.color.red))
                    statusTextView.visibility = View.VISIBLE
                    nextButton.visibility = View.GONE
                    cautionButton.visibility = View.VISIBLE
                    ...
                    binding.boundingBoxOverlay.setBoundingBoxes(emptyList())
                    statusTextView.text = "Detecting hand..."
                    statusTextView.visibility = View.VISIBLE
    ...
    private fun goToCautionInterface() {
        val intent = Intent(this, Caution::class.java)
        startActivity(intent)
        overridePendingTransition(R.animator.fade_in, R.animator.fade_out)
    }
