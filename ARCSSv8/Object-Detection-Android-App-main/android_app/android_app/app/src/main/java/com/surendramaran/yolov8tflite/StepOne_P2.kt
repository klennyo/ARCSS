...
class StepOne_P2 : AppCompatActivity(), Detector.DetectorListener {
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        runOnUiThread {
            ...
            val cpuSocket = boundingBoxes.filter { it.clsName == " CPU socket" }
            ...
            if (bestBox != null) {
                ...
                statusTextView.text = "PLACE THE CPU IN THE BOX!"
                statusTextView.visibility = View.VISIBLE
                nextButton.visibility = View.VISIBLE
                ...
                statusTextView.text = "NO CPU SOCKET DETECTED"
                statusTextView.visibility = View.VISIBLE
