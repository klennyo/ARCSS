...
class StepSix_LANCARD_P2 : AppCompatActivity() {
    private lateinit var bckButton: Button
    private lateinit var videoView: VideoView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.lancard_p2)
        bckButton = findViewById(R.id.bck)
        setupButtonListeners()
        videoView = findViewById(R.id.background_video)
        val backgroundUri = Uri.parse("android.resource://${packageName}/${R.raw.stepsix_lancard_p2}")
        ...
        Glide.with(this)
            .asGif()
            .load(R.drawable.lancard_p3)
            .into(findViewById(R.id.gifImageView))
    }

    fun onScreenTapped(view: View) {
        val intent = Intent(this, StepSix_LANCARD_P3::class.java)
