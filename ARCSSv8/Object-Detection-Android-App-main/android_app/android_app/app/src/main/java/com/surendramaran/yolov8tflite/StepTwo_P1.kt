...
class StepTwo_P1 : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this)
            .asGif()
            .load(R.drawable.cfan)
            .into(findViewById(R.id.gifImageView))
    }
    fun onScreenTapped(view: View) {
        val intent = Intent(this, StepTwo_P2::class.java)
    ...
    private fun setupButtonListeners() {
        bckButton.setOnClickListener {
            startActivity(Intent(this, StepOne_P2::class.java))
            overridePendingTransition(R.animator.fade_in, R.animator.fade_out)
        }
    }
