...
class StepFour_M2_P2 : AppCompatActivity(), Detector.DetectorListener {
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        runOnUiThread {
            ...
            val lanCardBoxes = boundingBoxes.filter { it.clsName == " M.2 Interface" }
            ...
            if (bestBox != null) {
                ...
                statusTextView.text = "SCREW THE M.2 IN THE BOX!"
                statusTextView.visibility = View.VISIBLE
                nextButton.visibility = View.VISIBLE
                ...
                statusTextView.text = "NO M.2 INTERFACE DETECTED"
                statusTextView.visibility = View.VISIBLE
